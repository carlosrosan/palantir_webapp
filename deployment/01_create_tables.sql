...
-- Table: faliure_probability_base (features: mechanical vibrations, RPM, power, current, pressure, flow, service time, days since failure/inspection)
CREATE TABLE palantir_maintenance.faliure_probability_base (
  ...
  `mechanical_vibration` decimal(12,4) DEFAULT NULL COMMENT 'Mechanical vibration (e.g. mm/s or g)',
  `rpm` decimal(10,2) DEFAULT NULL COMMENT 'Rotational speed (RPM)',
  `power` decimal(12,4) DEFAULT NULL COMMENT 'Power (kW)',
  `electrical_current` decimal(12,4) DEFAULT NULL COMMENT 'Electrical current (A)',
  `pressure` decimal(12,4) DEFAULT NULL COMMENT 'Pressure (bar)',
  `flow` decimal(12,4) DEFAULT NULL COMMENT 'Flow (L/min)',
  `asset_service_days` int DEFAULT NULL COMMENT 'Days in service since installation',
  `asset_service_hours` decimal(12,2) DEFAULT NULL COMMENT 'Estimated operating hours',
  `days_since_last_failure` int DEFAULT NULL COMMENT 'Days since last failure',
  `days_since_last_inspection` int DEFAULT NULL COMMENT 'Days since last visual inspection',
